function [OutputX, OutputY, dispImages,deltas, imin, Qualities, mins]=Ghost(imorig, checkDisplacements, smoothFactor)
...
%OutputY=smooth(ucid00001.tif,smoothFactor);
